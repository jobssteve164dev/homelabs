        ...
        <div className="overflow-y-auto max-h-[85vh] custom-scrollbar">
          ...
          <div className="relative p-8 pb-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
              className="absolute top-6 right-6 z-10 w-12 h-12 rounded-full glass-card border border-foreground/20 hover:border-neon-blue/80 flex items-center justify-center transition-all group"
            >
            ...
            >
              <div className="glass-card p-4 rounded-xl border border-neon-blue/30 hover:border-neon-blue/60 transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-neon-blue/20 flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <div className="glass-card p-4 rounded-xl border border-neon-green/30 hover:border-neon-green/60 transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-neon-green/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Heart className={`w-5 h-5 text-neon-green ${isLiked ? 'fill-neon-green' : ''}`} />
                  </div>
                  <div>
              ...
              <div className="glass-card p-4 rounded-xl border border-neon-purple/30 hover:border-neon-purple/60 transition-all group">
                <div className="flex items-center gap-3">
          ...
          <div className="px-8 pb-8 space-y-6">
            ...
            >
              <h3 className="text-lg font-display font-semibold text-foreground mb-4 flex items-center gap-2">
                <div className="w-1 h-5 bg-gradient-to-b from-neon-blue to-neon-purple rounded-full" />
                项目简介
              </h3>
              <p className="text-foreground/80 leading-relaxed text-base pl-5">
                {planet.description}
              </p>
            </motion.div>
            ...
            {planet.tags && planet.tags.length > 0 && (
              ...
              >
                <h3 className="text-lg font-display font-semibold text-foreground mb-4 flex items-center gap-2">
                  <div className="w-1 h-5 bg-gradient-to-b from-neon-purple to-neon-green rounded-full" />
                ...
                <div className="flex flex-wrap gap-2.5 pl-5">
                  {planet.tags.map((tag, index) => (
                    <motion.span
                      ...
                      className="px-4 py-2 rounded-lg text-sm font-medium border-2 border-neon-purple/40 text-neon-purple bg-neon-purple/10 hover:bg-neon-purple/20 hover:border-neon-purple/60 transition-all cursor-pointer"
                    >
                      #{tag}
                    </motion.span>
                  ))}
            ...
            <motion.div
              ...
              className="glass-card p-5 rounded-xl border border-foreground/10"
            >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex-1 relative group overflow-hidden rounded-xl p-4 font-semibold transition-all"
                style={{
              ...
              <motion.button
                whileHover={{ scale: 1.02, y: -2 }}
                whileTap={{ scale: 0.98 }}
                className="flex-1 glass-card border-2 border-foreground/20 hover:border-neon-blue/60 px-4 py-4 rounded-xl transition-all flex items-center justify-center gap-2 font-semibold group"
              >
              ...
              <motion.button
                ...
                className={`glass-card border-2 px-5 py-4 rounded-xl transition-all ${
                  isLiked 
